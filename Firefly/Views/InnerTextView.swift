...
public protocol InnerTextViewDelegate: class {
	func didUpdateCursorFloatingState()
}

public class InnerTextView: UITextView {
    ...
    var theme: Theme? {
        didSet(theme) {
            if theme != nil {
                (textStorage as? CodeAttributedString)?.highlightr.theme = theme
            }
        }
    }
